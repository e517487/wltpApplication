 ...
 * 
 */
@WebFault(name = "ServiceException", targetNamespace = "http://xml.inetpsa.com/Services/Cfg/Config")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: com.inetpsa.pct00.application.service.wltp.ServiceException
     */
